            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>mantenimiento/alumnos/update" method="POST">
                           <input type="hidden" value="<?php echo $alumno->id_alumn;?>" name="idAlumno">

                            <div class="form-group <?php echo form_error('nombres_alumn') == true ? 'has-error': '';?>">
                                <label for="nombre_espe">Nombres:</label>
                                <input type="text" class="form-control" id="nombres_alumn" name="nombres_alumn" value="<?php echo $alumno->nombres_alumn?>">
                           ...
                           <div class="form-group <?php echo form_error('apellidos_alumn') == true ? 'has-error': '';?>">
                                ...
                                <input type="text" class="form-control" id="apellidos_alumn" name="apellidos_alumn" value="<?php echo $alumno->apellidos_alumn?>">
                           ...
                           <div class="form-group <?php echo form_error('dni') == true ? 'has-error': '';?>">
                                ...
                                <input type="number" class="form-control" id="dni" name="dni" value="<?php echo $alumno->dni?>">
                           ...
                           <div class="form-group <?php echo form_error('telefono_alumn') == true ? 'has-error': '';?>">
                                ...
                                <input type="number" class="form-control" id="telefono_alumn" name="telefono_alumn" value="<?php echo $alumno->telefono_alumn?>">
